...
/**
 * Check if a score uses light text (for contrast)
 */
export function scoreUsesLightText(score: Exclude<Score, null>): boolean {
  return score >= 2; // Scores 2 and 3 use white text
}
